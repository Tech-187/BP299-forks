...
--[[
    Original can be found athttps://github.com/Tech-187/Lua-scripts/blob/main/BetterPerson299.lua

    The command sabotage has been renamed to exile, it now uses a lag script from v3rm which will get patched soon.
    But for now you can use this to lag the hell out of players.

    Having a script that has a form of altered punish is recommended
]]
            ...
            createKohlsUi(
                {
                    ...
                    "m message (bp299)",
                    "emr (crasher)(K)",
                    "exile bp299 (lags and blinds them)",
