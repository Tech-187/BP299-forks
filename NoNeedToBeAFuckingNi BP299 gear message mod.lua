...
local uniquemodstring = "BetterNigger299" -- Change this to whatever, just don't add any spaces or it may break the commands that contain the "watermark"
...
local gearcons = {}
getgenv().BlacklistedGear = {"VampireVanquisher","IvoryPeriastron","PaintBucket","SubspaceTripmine","Transmorpher","LaserFingerPointers","SeaThemedCrossbow","RageTable","IceStaff","BlackHoleSword","ViridianThrowingKnives"} -- You can find the tool names using this script https://raw.githubusercontent.com/Tech-187/Lua-scripts/main/Inventory%20tool%20checker
getgenv().gearwhitelisted = {"Master0fSouIs","ScaleneSoap9803","t_echr","Humangas","ovicaI","Ba_lIon","naomicaesar","jjjuuikjjikkju","SoaringLys","Di33le2","jhjssikeksms"} -- Players that are in this table won't get ungeared by default.
...
shared.gpcheck = false -- Only boot if you have the gamepass (recommended for autoexec). Cannot be altered after the script ran obviously
...
getgenv().GEARANNOUNCE = true --// MOD. Turn this off if it lags you. It also makes the gear blacklist less strict
